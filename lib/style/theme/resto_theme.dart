...
import 'package:resto_app/style/colors/resto_colors.dart';
import 'package:resto_app/style/typography/resto_text_styles.dart';

class RestoTheme {
  static ThemeData get lightTheme {
    return ThemeData(
      colorSchemeSeed: RestoColors.lightGreen.color,
